...
export default function TriviaCreationModal({
  ...
  return (
    <div className={cn('fixed', 'inset-0', 'flex', 'items-center', 'justify-center', 'bg-black/60', 'z-[9999]')}>

      <div className={cn('bg-white', 'dark:bg-neutral-900', 'w-full', 'max-w-xl', 'p-6', 'rounded-xl', 'shadow-2xl', 'space-y-6', 'animate-fadeIn')}>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                if (e.target.checked) {
                  ...
                  setRoundTopics(Array.from({ length: numRounds }, () => ''));
                }
              }}
              className="sr-only"
            />
        ...
        <button
          ...
          className={cn('w-full', 'py-3', 'mt-4', 'bg-blue-600', 'hover:bg-blue-700', 'text-white', 'font-semibold', 'rounded-lg', 'transition-all')}
        >
          🚀 Generate Trivia
        </button>
      </div>
